  ...
  return (
    <Card className="w-full h-[800px] md:h-[600px] bg-white dark:bg-black/[0.96] relative overflow-hidden border-zinc-200 dark:border-zinc-800 shadow-xl dark:shadow-none transition-colors duration-300">
      ...
      <div className="flex flex-col md:flex-row h-full">
        {/* Left content */}
        <div className="flex-1 p-8 relative z-10 flex flex-col justify-center items-center text-center overflow-hidden">
          
          <div className="relative z-10">
            <AnimatedHemloTitle className="mb-2" />

            <p className="mt-2 text-zinc-600 dark:text-white max-w-lg text-lg text-center font-medium mx-auto">
