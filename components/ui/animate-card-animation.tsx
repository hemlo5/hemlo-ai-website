...
export default function AnimatedCardStack({ autoplay = false, className }: AnimatedCardStackProps) {
  ...
  const handleAnimate = React.useCallback(() => {
    ...
    setTimeout(() => setIsAnimating(false), 600) // Debounce animation state slightly
